...
export default function OperationsPage() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case "planning":
        return "bg-axalio-green/20 text-axalio-green"
      case "completed":
        return "bg-white/20 text-white"
      case "compromised":
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-foreground tracking-wider font-mono">OPERATIONS CENTER</h1>
          <p className="text-sm text-muted-foreground">Mission planning and execution oversight</p>
        </div>
        <div className="flex gap-2">
          <Button className="bg-axalio-green hover:bg-axalio-green/90 text-black tracking-wider font-mono">
            NEW OPERATION
          </Button>
          <Button className="bg-axalio-green hover:bg-axalio-green/90 text-black tracking-wider font-mono">
            MISSION BRIEF
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-card border-border">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-muted-foreground tracking-wider font-mono">ACTIVE OPS</p>
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-muted-foreground tracking-wider font-mono">COMPLETED</p>
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-muted-foreground tracking-wider font-mono">SUCCESS RATE</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {operations.map((operation) => (
          <Card
            key={operation.id}
            className="bg-card border-border hover:border-axalio-green/50 transition-colors cursor-pointer"
            onClick={() => setSelectedOperation(operation)}
          >
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div>
                  <CardTitle className="text-sm font-bold text-foreground tracking-wider font-mono">
                    {operation.name}
                  </CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-muted rounded-full h-2">
                  <div
                    className="bg-axalio-green h-2 rounded-full transition-all duration-300"
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <Card className="bg-card border-border w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                <CardTitle className="text-xl font-bold text-foreground tracking-wider font-mono">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2 font-mono">
                      OPERATION STATUS
                    </h3>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-foreground font-mono">{selectedOperation.agents}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Start Date:</span>
                        <span className="text-foreground font-mono">{selectedOperation.startDate}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Est. Completion:</span>
                        <span className="text-foreground font-mono">{selectedOperation.estimatedCompletion}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2 font-mono">PROGRESS</h3>
                    <div className="space-y-2">
                      ...
                      <div className="w-full bg-muted rounded-full h-3">
                        <div
                          className="bg-axalio-green h-3 rounded-full transition-all duration-300"
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2 font-mono">OBJECTIVES</h3>
                    <div className="space-y-2">
              ...
              <div>
                <h3 className="text-sm font-medium text-foreground tracking-wider mb-2 font-mono">DESCRIPTION</h3>
              ...
              <div className="flex gap-2 pt-4 border-t border-border">
                ...
                <Button
                  variant="outline"
                  className="border-border text-muted-foreground hover:bg-accent hover:text-accent-foreground tracking-wider font-mono bg-transparent"
                >
                  VIEW REPORTS
                </Button>
                <Button
