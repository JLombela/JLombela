      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <Card className="lg:col-span-4 bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-foreground tracking-wider font-mono">
              AGENT ALLOCATION
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-4 bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-foreground tracking-wider font-mono">ACTIVITY LOG</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {[
                ...
                <div
                  key={index}
                  className="text-xs border-l-2 border-axalio-green pl-3 hover:bg-accent p-2 rounded transition-colors"
                >
                  <div className="text-muted-foreground font-mono">{log.time}</div>
                  <div className="text-foreground">
                    Agent <span className="text-axalio-green font-mono">{log.agent}</span> {log.action}{" "}
                    <span className="text-foreground font-mono">{log.location}</span>
                    {log.target && (
                      <span>
                        {" "}
                        with agent <span className="text-axalio-green font-mono">{log.target}</span>
                      </span>
                    )}
                  </div>
                </div>
        ...
        <Card className="lg:col-span-4 bg-card border-border">
          ...
          <CardContent className="flex flex-col items-center">
            ...
            <div className="text-xs text-muted-foreground space-y-1 w-full font-mono">
              ...
              <div className="text-axalio-green">{"> CH#2 | 1231.9082464.500...xR3"}</div>
