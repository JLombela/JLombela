    ...
    <div className="p-6 space-y-6 px-0 py-0">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-axalio-green hover:bg-axalio-green/90 text-black tracking-wider">NEW OPERATION</Button>
          <Button className="bg-axalio-green hover:bg-axalio-green/90 text-black tracking-wider">MISSION BRIEF</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {operations.map((operation) => (
          <Card
            key={operation.id}
            className="bg-neutral-900 border-neutral-700 hover:border-axalio-green/50 transition-colors cursor-pointer"
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button
                ...
                className="text-neutral-400 hover:text-white tracking-wider"
              >
                ✕
              </Button>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-axalio-green hover:bg-axalio-green/90 text-black tracking-wider">
                  UPDATE STATUS
                </Button>
                <Button
                  variant="outline"
                  className="border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-300 bg-transparent tracking-wider"
                >
                  VIEW REPORTS
                </Button>
                <Button
